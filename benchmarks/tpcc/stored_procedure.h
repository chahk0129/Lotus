...
class tpcc_stored_procedure_t : public stored_procedure_t {
public:
    tpcc_stored_procedure_t(base_query_t* query);
    tpcc_stored_procedure_t(txn_id_t txn_id);
    ~tpcc_stored_procedure_t() = default;
