...
// client constructor
tpcc_stored_procedure_t::tpcc_stored_procedure_t(base_query_t* query)
    : stored_procedure_t(query) { init(); }

// server constructor
tpcc_stored_procedure_t::tpcc_stored_procedure_t(txn_id_t txn_id)
    : stored_procedure_t(txn_id) { init(); }
      
void tpcc_stored_procedure_t::init() {
...
uint32_t tpcc_stored_procedure_t::get_txn_type() {
    return ((tpcc_query_t*)_query)->type;
}

RC tpcc_stored_procedure_t::execute() {
...
RC tpcc_stored_procedure_t::execute_payment() {
...
RC tpcc_stored_procedure_t::execute_new_order() {
...
RC tpcc_stored_procedure_t::execute_order_status() {
...
RC tpcc_stored_procedure_t::execute_delivery() {
...
RC tpcc_stored_procedure_t::execute_stock_level() {
